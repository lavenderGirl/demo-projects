...
exports.Home = exports.DMP = exports.SAYQ = exports.TJYQ = exports.qianduGetData = exports.DZSP = exports.DPDB = exports.DPXX = undefined;
...
var pcUrl = 'https://xapi.x2era.com/w';
if (_url.indexOf('xrpt.x2era.com') >= 0) {
    _url = 'https://xapi.x2era.com';
} else if (_url.indexOf('xrpt-test.x2era.com') >= 0) {
    _url = 'https://xapi-test.x2era.com';
} else if (_url.indexOf('xrpt-dev.x2era.com') >= 0) {
...
//点评信息接口
var DPXX = exports.DPXX = {
    //获取门店信息
    getBrandShop: function getBrandShop(apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/class');
    },

    //获取评论最早与最晚时间
    dataSyncTime: function dataSyncTime(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/time_interval', paramsObj, 'POST');
    },

    //基础信息模块数据
    getBasicData: function getBasicData(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/basic_data', paramsObj, 'POST');
    },

    //用户评论模块数据
    getUserComment: function getUserComment(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/category_comment', paramsObj, 'POST');
    },

    //词云数据
    getWordCloudData: function getWordCloudData(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/comment', paramsObj, 'POST');
    },

    //TOP产品模块数据
    getTopFoodData: function getTopFoodData(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/top_food', paramsObj, 'POST');
    },

    //TOP门店模块数据
    getTopShopData: function getTopShopData(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/top_shop', paramsObj, 'POST');
    },

    //上新时间表模块数据
    getNewFoodData: function getNewFoodData(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/new_food', paramsObj, 'POST');
    }
};

//点评对比接口
var DPDB = exports.DPDB = {
    //获取门店信息
    getBrandShop: function getBrandShop(apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/class');
    },
    ...
    //获取对比门店信息
    getChildBrandShop: function getChildBrandShop(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/class', paramsObj, 'POST');
    },

    //店面比较饼图
    getBasicCompared: function getBasicCompared(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/basic_data_compared', paramsObj, 'POST');
    },

    //口味对比模块
    getTasteCompared: function getTasteCompared(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/taste_compared', paramsObj, 'POST');
    },

    //用户评论模块数据
    getCategoryCommentCompared: function getCategoryCommentCompared(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/category_comment_compared', paramsObj, 'POST');
    },

    //店铺词云模块数据
    getCommentCompared: function getCommentCompared(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/comment_compared', paramsObj, 'POST');
    },

    //TOP产品模块
    getTopFoodCompared: function getTopFoodCompared(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/top_food_compared', paramsObj, 'POST');
    },

    //TOP门店模块
    getTopShopCompared: function getTopShopCompared(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/top_shop_compared', paramsObj, 'POST');
    },

    //上新时间表模块
    getNewFoodCompared: function getNewFoodCompared(paramsObj, apiName) {
        return (0, _http2.default)(_url + '/api/brand_shop' + apiName + '/new_food_compared', paramsObj, 'POST');
    }
};

//大宗商品页面接口
var DZSP = exports.DZSP = {
    //控制引导页什么时候显示
    introControl: function introControl(token) {
        return (0, _http2.default)(_url + '/api/intro/shengzhu/' + token);
    },
    getPageData: function getPageData(paramsObj, urlName) {
        return (0, _http2.default)(pcUrl + '/' + urlName, paramsObj, 'GET');
    },
    getdatabycity: function getdatabycity(paramsObj) {
        return (0, _http2.default)(pcUrl + '/getdatabycity', paramsObj, 'GET');
    },
    getProvince: function getProvince(paramsObj) {
        return (0, _http2.default)(_url + '/api/province', paramsObj, 'POST');
    },
    getUserProvince: function getUserProvince(pageName, token) {
        return (0, _http2.default)(_url + '/api/province/' + pageName + '/' + token);
    },

    //期货页面接口
    getQiHuo: function getQiHuo(paramsObj) {
        return (0, _http2.default)(pcUrl + '/getqihuo', paramsObj, 'GET');
    }
};

//千度接口
var qianduGetData = exports.qianduGetData = function qianduGetData(paramsObj) {
    return (0, _http2.default)(pcUrl + '/getdoc', paramsObj, 'POST');
};

//推荐引擎接口
var TJYQ = exports.TJYQ = {
    getConfigData: function getConfigData() {
        return (0, _http2.default)(_url + '/api/recommend_system/combination_parameters/103302/ORDER_RECOMMENDER');
    },
    getPageData: function getPageData(paramsObj) {
        return (0, _http2.default)(_url + '/api/recommend_system', paramsObj, 'POST');
    }
};

// 食安舆情接口
var SAYQ = exports.SAYQ = {
    getBasicData: function getBasicData() {
        return (0, _http2.default)(_url + '/api/public_opinion/changed_total', null, 'POST');
    },
    getTableData: function getTableData(paramsObj, obj) {
        return (0, _http2.default)(_url + '/api/public_opinion/' + obj.url + '/' + obj.tabNum + '/' + obj.pageNum, paramsObj, 'POST');
    },
    getLayDetail: function getLayDetail(obj) {
        return (0, _http2.default)(_url + '/api/public_opinion/' + obj.apiName + '/' + obj.pid);
    },
    getNewTags: function getNewTags() {
        return (0, _http2.default)(_url + '/api/public_opinion/news_tags');
    },
    getNewList: function getNewList(paramsObj, obj) {
        return (0, _http2.default)(_url + '/api/public_opinion/news_list/' + obj.pageNum, paramsObj, 'POST');
    },
    getNewsDetail: function getNewsDetail(obj) {
        return (0, _http2.default)(_url + '/api/public_opinion/news_detail/' + obj.type + '/' + obj.pid);
    }
};

// DMP接口
var DMP = exports.DMP = {
    getUserLabelParam: function getUserLabelParam(param) {
        return (0, _http2.default)(_url + '/api/dmp/user_label/' + param);
    },
    getUserLabel: function getUserLabel() {
        return (0, _http2.default)(_url + '/api/dmp/user_label');
    },
    getUserLabel_post: function getUserLabel_post(paramsObj) {
        return (0, _http2.default)(_url + '/api/dmp/user_label', paramsObj, 'POST');
    },
    getDownload: function getDownload(paramsObj, obj) {
        return (0, _http2.default)(_url + '/api/dmp/user_label/' + obj.number + '/download', paramsObj, 'POST');
    },
    getPortray: function getPortray() {
        return (0, _http2.default)(_url + '/api/dmp/user_label_portray');
    }
};

var Home = exports.Home = {
    controlGuide: function controlGuide(token) {
        return (0, _http2.default)(_url + '/api/guide/' + token);
    },
    controlLogin: function controlLogin(token) {
        return (0, _http2.default)(_url + '/api/auth/' + token);
    }
};
...
function ajax() {
    ...
    return new _promise2.default(function (resolve, reject) {
        // （利用axios）异步执行ajax请求
        var result = void 0; // 这个内部的promise用来保存axios的返回值(promise对象)
        if (type === 'GET') {
            // 准备 url query 参数数据
            ...
            // 发送 get 请求
            result = _axios2.default.get(url);
        } else {
            // 发送 post 请求
            result = _axios2.default.post(url, data);
        }
...
var bind = __webpack_require__(424);
var Axios = __webpack_require__(426);
var mergeConfig = __webpack_require__(444);
...
function getDefaultAdapter() {
  ...
  if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    ...
    adapter = __webpack_require__(435);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(433)))
...
var _jsCookie = __webpack_require__(475);
...
new vue({
    el: '#app',
    data: {
        isShowGuideBtn: false,
        isLogin: false,
        token: _jsCookie2.default.get('_token') ? _jsCookie2.default.get('_token') : '',
        isClickBtn: false,
        currentPageIndex: 1,
        guideIscollapse: true, //导览为收起
        guideCont: {
            cont1: true, //默认导览第一页显示
            cont2: false
        },
        guideMaxPage: 2, //目前只有两页
        isNextBtn: ''
    },
    mounted: function mounted() {
        this.controlGuideBtnShow();
        this.controlLogin();
    },
    methods: {
        controlGuideBtnShow: function () {
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return _api.Home.controlGuide(this.token);

                            case 2:
                                res = _context.sent;

                                if (res.data && res.data.userid) {
                                    this.isShowGuideBtn = true;
                                } else if (res.data && res.data.length == 0) {
                                    this.isShowGuideBtn = false;
                                } else {
                                    this.isShowGuideBtn = false;
                                }
            ...
            function controlGuideBtnShow() {
                return _ref.apply(this, arguments);
            }

            return controlGuideBtnShow;
        }(),
                ...
                return _regenerator2.default.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return _api.Home.controlLogin(this.token);
        ...
        showGuide: function showGuide() {
            ...
            this.guideIscollapse = !this.guideIscollapse;
            this.currentPageIndex = 1;
            for (var key in this.guideCont) {
                this.guideCont.cont1 = true;
                if (key !== 'cont1') {
                    this.guideCont[key] = false;
                }
            }
        },
        showPage: function showPage(isNextBtn) {
            this.isNextBtn = isNextBtn;
            this.isClickBtn = false;
            if (isNextBtn) {
                if (this.currentPageIndex == this.guideMaxPage) {
                    return false;
                } else {
            ...
            for (var key in this.guideCont) {
                this.guideCont['cont' + this.currentPageIndex] = true;
                if (key !== 'cont' + this.currentPageIndex) {
                    this.guideCont[key] = false;
                }
            }
        }
